            ...
            <div className='cart__item'>
                ...
                <div className='cart__info-container'>
                    <div className="cart__counter-wrapper">
                        <div  onClick={() => {props.decrease(props.item.id)}} className="cart__items-minus">-</div>
                        <div className="cart__items-current">{props.count}</div>
                        <div onClick={() => {props.increase(props.item.id)}} className="cart__items-plus">+</div>
                    </div>
